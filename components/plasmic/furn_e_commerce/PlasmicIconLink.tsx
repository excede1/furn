...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: MBURqNJ1bopajB/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__yzcPa)}
              role={"img"}
            />
          ),
